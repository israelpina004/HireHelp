...
export default function ApplicationTrackingClient({ userName, initials, email }: ApplicationTrackingClientProps) {
    ...
    function openEdit(app: Application) {
        setForm({ company: app.company, position: app.position, status: app.status, atsScore: String(app.atsScore), matchScore: String(app.matchScore), appliedDate: app.appliedDate });
