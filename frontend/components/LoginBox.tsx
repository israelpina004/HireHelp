            ...
            <div style={{ width: "45%", background: "#0a0a0a", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "48px 52px", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ animation: "fadeUp 0.5s ease 0.1s both" }}>
                    ...
                    <h1 style={{ fontSize: 42, fontWeight: 700, color: "#fff", lineHeight: 1.15, letterSpacing: "-0.03em", fontFamily: "'DM Serif Display', Georgia, serif", marginBottom: 20 }}>
                        Land your<br /><em style={{ fontStyle: "italic", color: "#ffffff99" }}>dream job</em><br />faster.
                    </h1>
                    <p style={{ fontSize: 14.5, color: "#ffffff66", lineHeight: 1.7, maxWidth: 340 }}>
                        AI-powered resume optimization, ATS simulation, and behavioral interview prep — all in one place.
                    </p>
                </div>
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 40px" }}>
                <div style={{ width: "100%", maxWidth: 400, animation: "fadeUp 0.5s ease 0.15s both" }}>
                    <div style={{ marginBottom: 36 }}>
                        <h2 style={{ fontSize: 28, fontWeight: 700, color: "#0a0a0a", letterSpacing: "-0.03em", fontFamily: "'DM Serif Display', Georgia, serif", marginBottom: 8 }}>Welcome back</h2>
                        <p style={{ fontSize: 14, color: "#aaa" }}>Sign in to continue to HireHelp</p>
                    </div>
                    ...
                    <form action={formAction} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                        ...
                        <p style={{ textAlign: "center", fontSize: 13.5, color: "#aaa", marginTop: 6 }}>
                            ...
                            <a href="/auth/signup" className="hh-link" style={{ fontWeight: 600, color: "#888", textDecoration: "none", transition: "color 0.15s" }}>
                                Sign up
                            </a>
                        </p>
                    </form>
